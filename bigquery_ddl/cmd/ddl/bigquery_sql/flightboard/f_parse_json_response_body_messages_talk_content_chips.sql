CREATE OR REPLACE FUNCTION flightboard.f_parse_json_response_body_messages_talk_content_chips(s STRING) 
RETURNS ARRAY<STRUCT<talk STRUCT<type STRING, content STRUCT<chips ARRAY<STRUCT<item_name STRING, item_value STRING>>>>>> LANGUAGE js
OPTIONS(
